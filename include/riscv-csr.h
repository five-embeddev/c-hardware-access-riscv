...
// NOLINTBEGIN (hicpp-no-assembler, cppcoreguidelines-init-variables)
// hicpp-no-assembler: This cannot be implemented without assembler.
// cppcoreguidelines-init-variables: These variables are all output registers.
...
// NOLINTEND (hicpp-no-assembler, cppcoreguidelines-init-variables)
